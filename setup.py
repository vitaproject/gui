...
setup(
    ...
    version="0.1",
    license="LGPL-2.1",
    namespace_packages=['vitagui'],
    description='The VITA graphical user interface for in-vessel components assessments',
    classifiers=[
